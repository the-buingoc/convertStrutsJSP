...
<head>
	...
	<link href="../css/ledger/property.css" media="all" rel="stylesheet" type="text/css" >
...
<body>
	<div id="contents">
		...
		<div id="content_main">
			<dl>
				<dt><img src="../images/mark2.gif" width="13px" height="15px" class="img_mark">物件検索</dt>
				<dd>
					<div class="header_title"><p>検索条件</p></div>

					<form:form method="post" modelAttribute="changeThisFormName">
						...
						<table class="comm_tbl comm_tbl_center">
							<tr>
								...
								<td class="td_top">
									...
									<form:errors path="search_property_name" />
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<form:errors path="search_partner_name" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2" class="submit_area td_bottom">
									<button type="submit" class="btn_100" name="search">検　索" onclick="$('#p').val('0');</button>
								</td>
							</tr>
						</table>
					</form:form>
...
<c:if test="${searchListCnt >= 0}">
					...
					<div class="header_title">
						<input type="button" value="新規登録" class="btn_150 btn_new" onclick="location.href='../ledger/property/'">
						<p>検索結果</p>
					</div>
					...
					<c:forEach var="item" items="${itemList}" varStatus="status">
						...
						<c:choose>
							...
							<td class="td_func">
								<input type="button" class="btn_60" value="編集" onclick="location.href='../ledger/property/update/?property_id=${item.propertyId}'">
							</td>
						</tr>
